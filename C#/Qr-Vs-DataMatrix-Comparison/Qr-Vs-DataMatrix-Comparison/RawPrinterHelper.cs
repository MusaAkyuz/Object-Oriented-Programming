...
namespace Qr_Vs_DataMatrix_Comparison
{
    public class RawPrinterHelper
    {
        ...
        //public static bool SendBytesToPrinter(string printerName, List<FileModel> allFiles)
        //{
        //    //-------------------------------------------------
        ...
        //                    {
        //                        string zpl = PDFtoZPL.Conversion.ConvertPdfPage(bytes, null, i, 203, null, null, false, false);
        //                        IntPtr pBytes = Marshal.StringToCoTaskMemAnsi(zpl);
        //                        Int32 dwCount = zpl.Length;
        //                        // Write your bytes.
        ...
        //    {
        //        writer.WriteLine("Create Document : Dosyayı Yazdır " + watch.ElapsedMilliseconds.ToString() + " ms");
