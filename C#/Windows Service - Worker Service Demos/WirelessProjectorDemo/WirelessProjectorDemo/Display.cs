...
namespace WirelessProjectorDemo
{
    internal class Display
    {
        private const string SelectedDeviceKey = "Microsoft Print to PDF";
        ...
        public Display(Action<string> onDeviceSelected)
        {
            ...
            Console.WriteLine(_picker.ToString);
        }
